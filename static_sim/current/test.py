...
s, electrodes, electrodes_dict = load_trap(filename=str(os.path.dirname(os.path.abspath(__file__)))+'/single_chip.gds',
          ito_layer=12, electrode_mapping=electrode_mapping,
          electrode_ordering=electrode_ordering, plot=True,
          xlim=(-5000,5000), ylim=(-3000,3000), trap_center=trap_center)
